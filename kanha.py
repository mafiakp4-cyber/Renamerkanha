...
USERNAME = os.getenv("USERNAME", "kxxow123")
PASSWORD = os.getenv("PASSWORD", "kxxow123")
BOT_TOKEN = os.getenv("BOT_TOKEN", "8299886777:AAFsNWr4QDEpFCKEgcGDDtR5sTPQXKepfmk")
CHAT_ID = "-1002272282066"
DEVELOPER_ID = "@kxxow"  # Replace with your Telegram ID
CHANNEL_LINK = "https://t.me/+gxKh9Mnr1_hkMjY1" # Replace with your Telegram channel ID
...
async def send_telegram_message(current_time, country, number, sender, message):
    ...
    formatted = (
        ...
        f"<blockquote>💥 <b>Powered By: @kxxow </b></blockquote>\n"
    )
...
ADMIN_ID = 7665143902  # <-- apna Telegram numeric ID yaha daalo
...
async def start_command(update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text("✅ Bot is Active & Running! Contact If Any Problem @kxxow")
